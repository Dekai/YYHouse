...
public class ImageText extends LinearLayout{
	...
	private final static int DEFAULT_IMAGE_WIDTH = 96;
	private final static int DEFAULT_IMAGE_HEIGHT = 96;
	...
	public void setChecked(int itemID){
		...
		switch (itemID){
		case Constant.BTN_FLAG_CONTRACT:
			checkDrawableId = R.drawable.contract;
			break;
		case Constant.BTN_FLAG_HOUSE:
			checkDrawableId = R.drawable.house;
			break;
		case Constant.BTN_FLAG_RENTAL:
			checkDrawableId = R.drawable.rental;
			break;
		case Constant.BTN_FLAG_SETTING:
			checkDrawableId = R.drawable.setting;
			break;
		default:break;
		}
		if(mImageView != null){
